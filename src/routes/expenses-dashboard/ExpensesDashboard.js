...
const ExpensesDashboard = ({
  ...
  expenseTable,
  getRecordInfo,
  toggleExistingRecords,
  setIncomeTab,
  deleteExistingRecord,
  cancelEditExpenseRecord,
  ...
  const { getexpenses,expenses,incomes} = context;
    ...
    <main className="expenses-dashboard">
      <article>
        <section className="expenses-action-btns">
          <button className="dash-button" onClick={toggleExpenseModal}>
            Add expense &#65291;
          </button>
          <button className="dash-button" onClick={toggleIncomeModal}>
            Add Income &#65291;
          </button>
        </section>
      </article>
      <article className="expenses-grid">
        <section className="expenses-tabs">
          <button
            onClick={setExpenseTab}
            className={`${expenseTable ? "active-tab" : null}`}
          >
            Expenses
          </button>
          <button
            onClick={setIncomeTab}
            className={`${expenseTable ? null : "active-tab"}`}
          >
            Incomes
          </button>
        </section>
