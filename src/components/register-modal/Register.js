    ...
    <div className={"modal"}>
      ...
      <div className={"modal__box"}>
        <div className="modal__close">
          <button onClick={props.closeSignup}>
            <span>&#10005;</span>
          </button>
        </div>
        <div className={"modal__title"}>Sign Up</div>
        <div className="modal__sub_title">Sign up to get started</div>
        <div className={"modal__content"}>
          <form onSubmit={HandleSignUp}>
            ...
            <button className="submit-btn basic-button" type="submit">
              Sign up
            </button>
          </form>
          <div className="have-account">
            ...
            <button
              className="login-btn basic-button"
              onClick={() => {
                props.closeSignup();
                props.openLogin();
              }}
